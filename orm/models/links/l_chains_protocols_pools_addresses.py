...
class LinkChainsProtocolsPoolsAddresses(Base):
    ...
    __tablename__ = 'l_chains_protocols_pools_wallets_addresses'
    ...
    l_address_wallet_pool_id = Column(Integer, ForeignKey('l_addresses_wallets_pools.l_address_wallet_pool_id'), nullable=False)
